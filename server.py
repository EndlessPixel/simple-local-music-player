...
class MyHandler(BaseHTTPRequestHandler):
    ...
    def guess_type(self, path):
        ...
        types = {
            '.mp3': 'audio/mpeg','.wav': 'audio/wav','.ogg': 'audio/ogg','.flac': 'audio/flac','.m4a': 'audio/m4a','.aac': 'audio/aac','.html': 'text/html','.js': 'application/javascript','.css': 'text/css'}
        return types.get(ext, 'application/octet-stream')
if __name__ == '__main__':
    HTTPServer(('0.0.0.0', 18250), MyHandler).serve_forever()
